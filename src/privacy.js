    ...
    <div class="row">
      <div class="col-12">
        ...
        <p>
          ...
          Website, located at omisej.com. Please read our Privacy Policy
        ...
        <h3 class="mt-5">Information You Provide to Us</h3>
        <p>
          ...
          our Website Site or otherwise contacting us.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            Payment Information. If you choose to donate to our site, we collect
            payment information through our payment processor. All payment
            information is securely stored by our payment processor and we do
            not have access to your sensitive information, such as credit card
            number or security code.
          </li>
        </ul>
        <h3 class="mt-5">Automatically Collected Information</h3>
        <p>
        ...
        <h4 class="mt-4">Log Information</h4>
        <p>
        ...
        <p>
          ...
          context in which we collect it. We may process your personal
          information because:
        </p>
        <ul>
        ...
        <h2 class="mt-5">Service Providers</h2>
        <p>
          ...
          to perform Website-related services or to assist us in analyzing how
          our Website is used. These third-parties have access to your personal
        ...
        <h3 class="mt-4">Payments processors</h3>
        <p>
          We provide paid products and/or services on our Website. In that case,
        ...
        <h2 class="mt-5">Contacting Us</h2>
        <p>
